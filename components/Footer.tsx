...
const Footer = () => {
  return (
    <div className="flex flex-col text-dark px-[2rem] md:px-0 pt-16 pb-6 overflow-hidden">
      <div className="grid grid-cols-2 place-items-center md:place-items-start md:grid-cols-5 w-full">
        <div className="flex col-span-2 flex-col gap-4 md:pl-[6.5rem]">
          <Image src="/logo.svg" alt="footer" width={80} height={80} />
          <p className="text-[16px] text-[#515151] leading-[20px] font-normal w-[300px]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod. Lorem ipsum dolor sit amet, consectetur adipiscing elit,
            sed do eiusmod.
          </p>
        </div>
        <div className="flex flex-col w-full gap-6 pt-8 md:pt-0 pl-[4rem]">
