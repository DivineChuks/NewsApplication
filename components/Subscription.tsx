...
const Subscription = () => {
  return (
    <div className="flex flex-col py-[6.5rem] md:mx-[6.5rem]">
      <div className="flex-col bg-lightBlue px-[2rem] md:px-[6.5rem] py-[6.5rem] text-white">
        ...
        <div className="w-full mt-4 md:mt-[4rem] flex-col flex md:flex-row gap-[8px] items-center">
            <input
              className="w-full md:w-[80%] mb-2 md:mb-0 mt-1 text-[14px] px-[1.5rem] py-[1rem] text-[#000000E5] font-normal rounded-md"
